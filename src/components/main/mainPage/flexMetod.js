    ...
    return(
        <>
            <div className="wow animate__animated animate__fadeIn flex_metodolog ">
                <div className="wow animate__animated animate__bounceInLeft flex_metodolog_one">
                    <h3>
                ...
                <div className="flex_metodolog_column">
                    <div className="wow animate__animated animate__fadeInRight one_ block">
                        <p>600₽</p>
                        <p>Минимальная стоимость занятия</p>
                    </div>
                    <div className="wow animate__animated animate__fadeInRightBig two_ block">
                        <p>{'>'}1000</p>
                        <p>Учеников прошло через нашу школу</p>
                    </div>
                    <div className="wow animate__animated animate__fadeInRight three_ block">
                        <p>6</p>
                        <p>Сильных преподавателя</p>
                    </div>
                    <div className="wow animate__animated animate__fadeInRightBig four_ block">
                        <p>6</p>
